...
1. How does your catchability estimate compare to that published in @maceina_estimating_1995? Explain discrepancies (if any).
1. What is the best estimate and 95% confidence interval for the population size?
1. How does your populations size estimate compare to that published in @maceina_estimating_1995? Explain discrepancies (if any).
