...
5. Use the semi-random age assignment technique from @isermann_computer_2005 and the **observed** age-length key to assign ages to the unaged fish in the length-sample.  Combine the age-sample and the age-assigned length-sample into a single data frame and answer the following questions.
