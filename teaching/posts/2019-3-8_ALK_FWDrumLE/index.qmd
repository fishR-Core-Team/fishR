...
5. Use the semi-random age assignment technique from @isermann_computer_2005 and the **observed** age-length key to assign ages to the unaged fish in the length-sample. Combine the age-sample and the age-assigned length-sample into a single data frame to answer the following questions.
...
1. Compare your results using the "classical" method here to your results from using the @isermann_computer_2005 method in the previous section.
