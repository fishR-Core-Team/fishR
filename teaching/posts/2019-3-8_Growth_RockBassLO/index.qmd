...
3. Fit the Gallucci and Quinn (1979) parameterization.^[See `growthFunShow("vonBertalanffy",param="GQ",plot=TRUE)`) and [this](https://derekogle.com/IFAR/supplements/growth/OtherVBGFParams.html).]
