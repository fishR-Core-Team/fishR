...
#| label: fig-exCSVlink
#| echo: false
#| fig-cap: Partial view of the online documentation for `WalleyeErie2` data set in `FSAdata` showing the "CSV Link" link.
...
# Conclusion
In summary, we hope you will take advantage of the data resources provided in the `FSA` and `FSAdata` packages. However, we encourage you **not** to have students access the data through `data()` but instead to use the CSV links provided in the documentation as described above.
