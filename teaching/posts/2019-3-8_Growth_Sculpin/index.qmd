...
3. Fit the von Bertalanffy's original parameterization.^[See `growthFunShow("vonBertalanffy",param="original",plot=TRUE)`) and [this](https://derekogle.com/IFAR/supplements/growth/OtherVBGFParams.html).]
