...
This is a curated list of R packages related to fisheries and fisheries-related data and analyses. Access packages by type using the sidebar menu to the right. This was last updated on {{< meta date >}}.
:::
