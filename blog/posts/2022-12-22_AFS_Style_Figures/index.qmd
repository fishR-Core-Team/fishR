...
When I first ran the author's code I received an error about a missing font. I followed the advice in [this guide](https://github.com/wch/extrafont#using-extrafont) from the `extrafont` package but that did not seem to fix the issue. This is likely an issue with my system and something I need to look into further.
