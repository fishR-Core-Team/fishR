...
description: "How to construct age bias and age difference plots using ggplot2"
author: "Michael Lant"
date: "3/15/2021"
image: "preview.png"
categories:
...
```{r}
#| label: fig-plotAB
#| fig-cap: Default age-bias plot from `plotAB()`
#| fig-alt: Default age-bias plot from plotAB()
#| echo: -1
...
```{r}
#| label: fig-ABplot1
#| fig-cap: Age difference plot.
#| fig-alt: Age difference plot.
...
```{r}
#| label: fig-ABplot2
#| fig-cap: Age difference plot including points for individual observations.
#| fig-alt: Age difference plot including points for individual observations.
ggplot() +
  geom_hline(yintercept=0,linetype="dashed",color="gray") +
...
```{r}
#| label: fig-ABplot3
#| fig-cap: Age difference plot including points for individual observations and a loess smoother.
#| fig-alt: Age difference plot including points for individual observations and a loess smoother.
ggplot() +
  geom_hline(yintercept=0,linetype="dashed",color="gray") +
  geom_point(data=ab1$data,aes(x=otolithC,y=diff),alpha=0.1,size=1.75) +
  geom_errorbar(data=ab1$bias.diff,aes(x=otolithC,ymin=LCI,ymax=UCI,color=sig),
