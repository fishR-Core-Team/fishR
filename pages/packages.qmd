...
* [FLR: Fisheries Library in R](http://www.flr-project.org/index.html): *A collection of tools for quantitative fisheries science that facilitates the construction of bio-economic simulation models of fisheries systems*
...
* [fishboot](https://github.com/rschwamborn/fishboot): *A suite of bootstrap-based models and tools for the study of body growth and mortality of fish and macroinvertebrates using data from length-frequency distributions, tag-and-recapture, and readings of annual rings from hard structures*
...
* [hatchR](https://bmait101.github.io/hatchR/index.html): *Predict hatch and emergence timing for wild fish*
...
* [nichetools](https://benjaminhlina.github.io/nichetools/): *Complementary package to {nicheROVER} and {SIBER} allowing Bayesian posteriors to be extracted from objects created by {nicheROVER} or {SIBER}(e.g., niche size and similarities)*
...
* [rFAMS](https://fishr-core-team.github.io/rFAMS/): *Fisheries Analysis and Modeling Simulator in R*
...
* [trps](https://benjaminhlina.github.io/trps/index.html)" *Bayesian trophic position models using Stan*
